...
export default function App() {
  ...
  if (estado == 'leitura'){
    ...
    return (
      ...
      <TextInput style={{height:300, textAlignVertical:'top', padding:20}} onChangeText={(text) => setarAnotacao(text)} multiline={true} numberOfLines={5} value={anotacao}></TextInput>
